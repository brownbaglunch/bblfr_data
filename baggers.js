var data = {
  speakers: [
    ...
    },
    {
      ...
      bio:
        'Ergonome, UX Designer, Psychologue, en freelance depuis le dernier millénaire',
      ...
      sessions: [
        {
          ...
          abstract:
            'Le Persuasive Design est la façon dont les technologies de communication et le design peuvent influencer les comportements des utilisateurs durablement. Nous présentons les principes de bases et comment les mettre en œuvre dans un projet.',
          tags: [
            'Design',
            'Expérience utilisateur',
            'Ergonomie',
        ...
        },
        {
          ...
          abstract:
            'Le tri par carte est une méthodologie qui permet de construire la navigation dans un site Web sur la base des représentations mentales des utilisateurs. Je vous propose de découvrir les différentes étapes nécessaires pour réaliser un tri par cartes et en déduire une arborescence.',
          tags: [
            'Design',
            'Expérience utilisateur',
            'Ergonomie',
        ...
        },
        {
          ...
          abstract:
            "Je vous propose de découvrir les diverses méthodologies liées à l'ergonomie et l'UX design afin de comprendre leurs apports, quand et comment les utiliser. Cette approche peut aussi permettre d'aborder d'autres sujets en lien suivant vos questions : Comment faire travailler UX et Agile ? Mettre en place un processus UX dans une organisation ? Le ROI de l'UX et de l'ergonomie ?",
          tags: [
            'Design',
            'Expérience utilisateur',
            'Ergonomie',
      ...
      sessions: [
        {
          ...
          abstract:
            'Présentation de GoCD, outil remplacant avantageusement ce bon vieux Jenkins :D',
